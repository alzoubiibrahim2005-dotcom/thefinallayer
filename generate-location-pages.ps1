$base = "C:\Users\alzou\thefinallayer"
...
$locations = @(
  ...
  @{ city="Leeds";       slug="painter-decorator-leeds";       county="West Yorkshire";     lat="53.8008"; lng="-1.5491"; nearby="Headingley, Roundhay, Horsforth, Morley, Pudsey, Kirkstall, Chapel Allerton and Otley"; r1t="Ibrahim came across from Manchester to do our Victorian terrace in Headingley. Full interior — walls, ceilings, all the woodwork. Superb result and a fair price."; r1a="Rachel K."; r1l="Headingley, Leeds"; r2t="Did our living room and hallway in Roundhay. Great attitude, really tidy, and the finish was exactly what we wanted. Would use again."; r2a="James W."; r2l="Roundhay, Leeds"; r3t="Ibrahim decorated our rental flat in Morley between tenancies. Done in two days, left it looking brand new. Brilliant value."; r3a="Donna P."; r3l="Morley, Leeds"; blogSlug="painter-decorator-leeds-guide"; blogTitle="Painter and Decorator in Leeds: Costs, Services and What to Expect"; houseType="Leeds has a wide range of property types — Victorian back-to-back terraces and through-terraces are common in areas like Headingley, Hyde Park and Kirkstall, while Roundhay, Alwoodley and Moortown have larger 1930s and postwar semis and detached houses. New-build apartments are increasingly popular in the city centre and South Bank area. Many of the older Leeds properties have original coving, deep skirtings and plasterwork that rewards proper preparation before painting." }
)
...
$nearbyLinksMap = @{
  ...
  "Leeds"      = "Bolton|painter-decorator-bolton,Bury|painter-decorator-bury"
}
...
<div class="loc-grid">
  ...
  <a href="/painter-decorator-leeds/">Leeds</a>
</div>
'@
...
.breadcrumb li+li::before{content:"\203A";margin:0 0.4rem;color:var(--dim)}
...
function New-LocationPage {
  ...
  $faq1a = "A single bedroom in $city typically starts from $([char]163)200-$([char]163)350 for labour. A full 3-bedroom house repaint usually ranges from $([char]163)1,200-$([char]163)2,500 depending on condition and finish required. The Final Layer offers free, no-obligation quotes - call Ibrahim directly for an accurate price on your job."
  ...
  $html += "<link rel=`"icon`" href=`"/favicon.ico`" sizes=`"any`">`n"
  $html += "<link rel=`"icon`" type=`"image/svg+xml`" href=`"/favicon.svg`">`n"
  $html += "<link rel=`"apple-touch-icon`" href=`"/apple-touch-icon.png`">`n"
  ...
  $html += "    <li><a href=`"/blog`">Blog</a></li>`n"
